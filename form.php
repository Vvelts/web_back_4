                            ...
                            ?>
                             <h2 class="text-center">Форма</h2>
                              <form action="" method="POST">
                                    ...
                                    <label>
                                        День рождения:<br />
                                        <input name="date" type="date" <?php if ($errors['date'] || $errors['3']) {print 'class="error"' ;} ?> value="<?php print $values['date']; ?>" />
                                    </label><br />
                                    Пол:<br />
                                    <label><input type="radio" name="radio-group-1" <?php if ($errors['radio-group-1']) {print 'class="error"' ;} if($values['radio-group-1']=="m"){print "checked='checked'";}?> value="m" />
                                        Муж.</label>
                                    <label><input type="radio" name="radio-group-1" <?php if ($errors['radio-group-1']) {print 'class="error"' ;} if($values['radio-group-1']=="f"){print "checked='checked'";}?> value="f" />
                                        Жен</label><br />
                                    Кол-во конечностей:<br />
                                    <label><input type="radio" name="radio-group-2" <?php if ($errors['radio-group-2']) {print 'class="error"' ;} if($values['radio-group-2']=="1"){print "checked='checked'";}?> value="1" />
                                        1</label>
                                    <label><input type="radio" name="radio-group-2" <?php if ($errors['radio-group-2']) {print 'class="error"' ;} if($values['radio-group-2']=="2"){print "checked='checked'";}?> value="2" />
                                        2</label>
                                    <label><input type="radio" name="radio-group-2" <?php if ($errors['radio-group-2']) {print 'class="error"' ;} if($values['radio-group-2']=="3"){print "checked='checked'";}?> value="3" />
                                        3</label>
                                    ...
                                    <label><input type="checkbox" name="check-1" <?php  if($values['check-1']=="Y"){print "checked='checked'";}?> value="Y" />
